...
export const CodeExecutionInputSchema = z.object({
	...
	files: z
		...
		.optional()
		.describe("Files to upload to the sandbox before execution"),
	packages: z
		.array(z.string())
		.optional()
...
export const MedicalAnalysisInputSchema = z
	.object({
		analysisType: z
			.enum([
				"data_analysis",
		...
		parameters: z
			.record(z.any())
			.optional()
			.describe("Additional parameters for the analysis"),
...
export const ExecutionResultSchema = z.object({
	...
	files: z
		...
		.optional()
		.describe("Generated files from execution"),
...
export const MedicalAnalysisResultSchema = z
	.object({
		...
		recommendations: z
			.array(z.string())
			.optional()
			.describe("Medical recommendations based on analysis"),
	})
