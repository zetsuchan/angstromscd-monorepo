		...
		messages: [
			{
				id: "1",
				content:
					"What is the current consensus on Hydroxyurea dosing for pediatric sickle cell patients?",
				sender: "user",
				...
				citations: [
					{
						...
						snippet:
							"In the TWiTCH trial, escalation to MTD showed superior TCD velocity reduction compared to transfusions.",
					...
					},
					{
						...
						snippet:
							"Higher HU doses (MTD strategy) correlated with higher HbF induction and decreased VOE frequency.",
