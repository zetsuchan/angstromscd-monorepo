    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          if (options.onTick) {
          const stream = this.stream.AnthropicCompletion(
          prompt,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.ClinicalDecisionSupport(
          clinical_scenario,patient_data,treatment_options,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.DetermineToolUsage(
          query,context,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.DetermineToolUsageOllama(
          query,context,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.GenerateVisualizationCode(
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.GenerateVisualizationCodeOllama(
          request,data_context,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.LiteratureSearch(
          research_query,medical_domain,time_period,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.MedicalAnalysis(
          patient_data,symptoms,medical_history,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.MedicalChat(
          query,model,context,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.MedicalChatOllama(
          query,model,context,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.MedicalResearcher(
          query,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.PopulationRiskAnalysis(
          population_data,demographic_factors,environmental_factors,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.ProcessMedicalQuery(
          query,model,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.ResearchSynthesis(
          papers,research_question,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.RiskModeling(
          patient_profile,risk_factors,outcome_target,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.SimpleChat(
          query,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.SimpleCompletion(
          prompt,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for AnthropicCompletion", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for ClinicalDecisionSupport", error);
              }
              }
              };
              }
            ...
            query: string,context?: string | null,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ChatResponseWithTools, types.ChatResponseWithTools>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for DetermineToolUsage", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ChatResponseWithTools, types.ChatResponseWithTools>(
                  raw,
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for DetermineToolUsageOllama", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for GenerateVisualizationCode", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for GenerateVisualizationCodeOllama", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for LiteratureSearch", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for MedicalAnalysis", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for MedicalChat", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.MedicalChatResponse, types.MedicalChatResponse>(
                  raw,
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for MedicalChatOllama", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for MedicalResearcher", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for PopulationRiskAnalysis", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for ProcessMedicalQuery", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for ResearchSynthesis", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for RiskModeling", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for SimpleChat", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for SimpleCompletion", error);
              }
              }
              };
              }
