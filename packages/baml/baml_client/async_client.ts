...
export class BamlAsyncClient {
  ...
  async AnalyzePADenialForAppeal(
    ...
    try {
      ...
      return raw.parsed(false) as types.PAAppealStrategy
    } catch (error) {
  ...
  async ExtractPAClinicalData(
      medical_record: string,drug_name: string,
      __baml_options__?: BamlCallOptions
  ): Promise<types.PAExtractionResult> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return raw.parsed(false) as types.PAExtractionResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async GeneratePAClinicalJustification(
      ...
      __baml_options__?: BamlCallOptions
  ): Promise<types.PAJustificationResult> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return raw.parsed(false) as types.PAJustificationResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
...
class BamlStreamClient {
  ...
  ): BamlStream<partial_types.PAAppealStrategy, types.PAAppealStrategy> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return new BamlStream<partial_types.PAAppealStrategy, types.PAAppealStrategy>(
        raw,
        (a): partial_types.PAAppealStrategy => a,
        (a): types.PAAppealStrategy => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
      throw toBamlError(error);
  ...
  ExtractPAClinicalData(
      medical_record: string,drug_name: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, collector?: Collector | Collector[], env?: Record<string, string | undefined> }
  ): BamlStream<partial_types.PAExtractionResult, types.PAExtractionResult> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return new BamlStream<partial_types.PAExtractionResult, types.PAExtractionResult>(
        raw,
        (a): partial_types.PAExtractionResult => a,
        (a): types.PAExtractionResult => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
      throw toBamlError(error);
  ...
  GeneratePAClinicalJustification(
      patient_data: types.PAPatientData,drug_info: types.PADrugInfo,payer_requirements: types.PAPayerRequirements,diagnosis_codes: string[],
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, collector?: Collector | Collector[], env?: Record<string, string | undefined> }
  ): BamlStream<partial_types.PAJustificationResult, types.PAJustificationResult> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      ...
      return new BamlStream<partial_types.PAJustificationResult, types.PAJustificationResult>(
        raw,
        (a): partial_types.PAJustificationResult => a,
        (a): types.PAJustificationResult => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
      throw toBamlError(error);
